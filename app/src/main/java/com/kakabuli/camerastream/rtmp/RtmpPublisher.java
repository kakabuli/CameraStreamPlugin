package com.kakabuli.camerastream.rtmp;
...
public class RtmpPublisher {
    ...
    public RtmpPublisher(CameraStreamView view) {
        mCameraStreamView = view;
        mCameraStreamView.setPreviewCallback(new CameraStreamView.CameraCallback() {
            @Override
    ...
    public UVCCamera startCamera(USBMonitor.UsbControlBlock ctrlBlock) {
        return mCameraStreamView.startCamera(ctrlBlock);
    }

    public void stopCamera() {
        mCameraStreamView.stopCamera();
    }

    public boolean isOpened(){
        return mCameraStreamView.isOpened();
    }

    public boolean isEqual( UsbDevice device){
        Log.d(TAG,"isEqual");
        return mCameraStreamView.isEqual(device);
    }

    public void startPreview() {
        mCameraStreamView.startPreview();
    }

    public void stopPreview() {
        mCameraStreamView.stopPreview();
    }
    ...
    public void startEncode() {
        ...
        mCameraStreamView.enableEncoding();
    ...
    public void setPreviewResolution(int width, int height) {
        int resolution[] = mCameraStreamView.setPreviewResolution(width, height);
    ...
    public void setRtmpHandler(RtmpHandler handler, int messageId) {
        mFlvMuxer = new SrsFlvMuxer(handler,messageId);
        if (mEncoder != null) {
