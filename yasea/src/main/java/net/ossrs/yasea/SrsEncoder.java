...
public class SrsEncoder {
    ...
    private void onProcessedYuvFrame(byte[] yuvFrame, long pts) {
        Log.w("shulan_srsflvmuxer","srsflvmuxer对象" + this + "onProcessedYuvFrame--->");
    ...
    private void onSoftEncodedData(byte[] es, long pts, boolean isKeyFrame) {
        Log.w("shulan_srsflvmuxer","srsflvmuxer对象" + this + "onSoftEncodedData--->");
    ...
    private void onEncodedAnnexbFrame(ByteBuffer es, MediaCodec.BufferInfo bi) {
        Log.w("shulan_srsflvmuxer","srcflvmuxer--》" + this + "writeSampleData-----");
