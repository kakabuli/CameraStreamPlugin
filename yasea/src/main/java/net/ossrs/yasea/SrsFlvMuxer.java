...
public class SrsFlvMuxer {
     ...
     */
    public SrsFlvMuxer(RtmpHandler handler,int messageId) {
        publisher = new DefaultRtmpPublisher(handler,messageId);
    }
    ...
    public void writeSampleData(int trackIndex, ByteBuffer byteBuf, MediaCodec.BufferInfo bufferInfo) {
        ...
        Log.w("shulan_srsflvmuxer","srsflvmuxer对象" + this + "writeSampleData B帧---->");
        ...
        Log.w("shulan_srsflvmuxer","SrsFlv--》" + flv + "writeSampleData-----");
    ...
    private class SrsFlv {
        ...
        public void writeVideoSample(final ByteBuffer bb, MediaCodec.BufferInfo bi) {
            Log.w("shulan_srsflvmuxer","srsflvmuxer对象--》" + this + "writeVideoSample-----");
            if (bi.size < 4) return;
...
//                    writeH264SpsPps(dts, pts);
        ...
        private void writeH264IpbFrame(ArrayList<SrsFlvFrameBytes> frames, int type, int dts, int pts) {
            Log.w("shulan_srsflvmuxer","srsflvmuxer对象--》" + this + "writeH264IpbFrame-----");
        ...
        private void writeRtmpPacket(int type, int dts, int frame_type, int avc_aac_type, SrsAllocator.Allocation tag) {
            Log.w("shulan_srsflvmuxer","srsflvmuxer对象--》" + this + "writeRtmpPacket-----");
